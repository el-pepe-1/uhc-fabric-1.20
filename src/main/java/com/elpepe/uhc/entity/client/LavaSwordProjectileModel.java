...
public class LavaSwordProjectileModel<T extends LavaSwordProjectileEntity> extends SinglePartEntityModel<T> {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      lava_sword_projectile.addChild("ring", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -3.0F, 0.0F, 8.0F, 8.0F, 0.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
      ...
      ring2.addChild("cube_r1", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -3.0F, 0.0F, 8.0F, 8.0F, 0.1F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, -0.5236F, 0.0F));
      ModelPartData ring3 = lava_sword_projectile.addChild("ring3", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
      ring3.addChild("cube_r2", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -3.0F, 0.0F, 8.0F, 8.0F, 0.1F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 2.0944F, 0.0F));
      ModelPartData heart = lava_sword_projectile.addChild("heart", ModelPartBuilder.create().uv(0, 8).cuboid(-1.5F, -0.5F, 0.0F, 3.0F, 3.0F, 0.1F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
      heart.addChild("cube_r3", ModelPartBuilder.create().uv(0, 8).cuboid(-1.5F, -0.5F, 0.0F, 3.0F, 3.0F, 0.1F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, -2.0944F, 0.0F));
      heart.addChild("cube_r4", ModelPartBuilder.create().uv(0, 8).cuboid(-1.5F, -0.5F, 0.0F, 3.0F, 3.0F, 0.1F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 2.0944F, 0.0F));
   ...
   public void setAngles(T entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
      this.getPart().traverse().forEach(class_630::method_41923);
