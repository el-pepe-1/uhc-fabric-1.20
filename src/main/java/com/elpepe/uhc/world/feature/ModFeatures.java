...
public class ModFeatures {
   public static final Feature<SingleStateFeatureConfig> DEAD_TREE;
   public static final Feature<OverchargeRockFeatureConfig> BIG_ROCK;

   private static <C extends FeatureConfig, F extends Feature<C>> F register(String name, F feature) {
      return (Feature)Registry.register(Registries.FEATURE, new Identifier(Uhc.MOD_ID, name), feature);
   }
   ...
   static {
      DEAD_TREE = register("dead_tree", new DeadTreeFeature(SingleStateFeatureConfig.CODEC));
