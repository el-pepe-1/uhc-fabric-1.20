...
public class ModPlacedFeature {
   ...
   public static void bootstrap(Registerable<PlacedFeature> context) {
      ...
      register(context, DEAD_TREE_PLACED_KEY, configuredFeatureRegistryLookup.getOrThrow(ModConfiguredFeatures.DEAD_TREE_KEY), List.of(RandomOffsetPlacementModifier.of(ConstantIntProvider.create(1), ConstantIntProvider.create(6)), SquarePlacementModifier.of(), CountMultilayerPlacementModifier.of(1), BiomePlacementModifier.of()));
      register(context, BIG_ROCK_PLACED_KEY, configuredFeatureRegistryLookup.getOrThrow(ModConfiguredFeatures.BIG_ROCK_KEY), List.of(RandomOffsetPlacementModifier.of(ConstantIntProvider.create(1), ConstantIntProvider.create(6)), SquarePlacementModifier.of(), CountMultilayerPlacementModifier.of(1), BiomePlacementModifier.of()));
      register(context, NITHRIL_ORE_PLACED_KEY, configuredFeatureRegistryLookup.getOrThrow(ModConfiguredFeatures.NITHRIL_ORE_KEY), ModOrePlacement.modifiersWithCount(1, HeightRangePlacementModifier.uniform(YOffset.fixed(-80), YOffset.fixed(80))));
   }
