...
public class ModConfiguredFeatures {
   ...
   public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
      ...
      List<OreFeatureConfig.class_5876> overchargeNithrilOres = List.of(OreFeatureConfig.createTarget(stoneReplaceables, ModBlocks.NITHRIL_ORE.getDefaultState()));
      register(context, DEAD_TREE_KEY, ModFeatures.DEAD_TREE, new SingleStateFeatureConfig(ModBlocks.DEAD_LOG.getDefaultState()));
      register(context, BIG_ROCK_KEY, ModFeatures.BIG_ROCK, new OverchargeRockFeatureConfig(4, new RandomStateFeatureConfig(List.of(new RandomStateFeatureConfig.RandomStateEntry(Blocks.ANDESITE.getDefaultState(), 0.1F), new RandomStateFeatureConfig.RandomStateEntry(Blocks.COBBLESTONE.getDefaultState(), 0.25F), new RandomStateFeatureConfig.RandomStateEntry(Blocks.STONE.getDefaultState(), 0.75F))), ModBlocks.GRAY_ICE.getDefaultState(), ModBlocks.CRYOGENIC_STONE.getDefaultState()));
