...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter) {
        ...
        createDoorRecipe(ModBlocks.DEAD_PLANKS_DOOR, Ingredient.ofItems(ModBlocks.DEAD_PLANKS))
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, ModItems.DRAGON_PICKAXE, 1)
                .pattern("LHL")
                .pattern("EPE")
                .pattern("ObO")
                .input('L', Items.LAPIS_BLOCK)
                .input('H', Items.DRAGON_HEAD)
                .input('E', Items.EMERALD_BLOCK)
                ...
                .criterion(hasItem(Items.DRAGON_BREATH), conditionsFromItem(Items.DRAGON_BREATH)).offerTo(exporter, new Identifier(getRecipeName(ModItems.DRAGON_PICKAXE)));

        SmithingTransformRecipeJsonBuilder.create(Ingredient.EMPTY, Ingredient.ofItems(ModItems.DRAGON_PICKAXE), Ingredient.ofItems(Items.NETHERITE_INGOT), RecipeCategory.TOOLS, ModItems.NETHERITE_COVERED_DRAGON_PICKAXE)
                .criterion(hasItem(ModItems.DRAGON_PICKAXE), conditionsFromItem(ModItems.DRAGON_PICKAXE))
                .offerTo(exporter, new Identifier(getRecipeName(ModItems.NETHERITE_COVERED_DRAGON_PICKAXE)));

        SmithingTransformRecipeJsonBuilder.create(Ingredient.EMPTY, Ingredient.ofItems(ModItems.EMERALD_SWORD), Ingredient.ofItems(ModItems.SHARP_STONE), RecipeCategory.COMBAT, ModItems.SHARP_EMERALD_SWORD)
                .criterion(hasItem(ModItems.EMERALD_SWORD), conditionsFromItem(ModItems.EMERALD_SWORD))
                .criterion(hasItem(ModItems.SHARP_STONE), conditionsFromItem(ModItems.SHARP_STONE))
                .offerTo(exporter, new Identifier(getRecipeName(ModItems.SHARP_EMERALD_SWORD)));
