...
public class ModModelProvider extends FabricModelProvider {
   ...
   public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
      ...
      BlockStateModelGenerator.class_4912 cryogenicStonePool = blockStateModelGenerator.registerCubeAllModelTexturePool(ModBlocks.CRYOGENIC_STONE);
      ...
      BlockStateModelGenerator.class_4912 cobbledCryogenicStonePool = blockStateModelGenerator.registerCubeAllModelTexturePool(ModBlocks.COBBLED_CRYOGENIC_STONE);
      ...
      BlockStateModelGenerator.class_4912 deadPlanksPool = blockStateModelGenerator.registerCubeAllModelTexturePool(ModBlocks.DEAD_PLANKS);
   ...
   public void generateItemModels(ItemModelGenerator itemModelGenerator) {
      ...
      itemModelGenerator.register(ModItems.MYSTERIOUS_TRADER_SPAWN_EGG, new Model(Optional.of(new Identifier("item/template_spawn_egg")), Optional.empty(), new TextureKey[0]));
      itemModelGenerator.register(ModItems.GOBLIN_SPAWN_EGG, new Model(Optional.of(new Identifier("item/template_spawn_egg")), Optional.empty(), new TextureKey[0]));
   }
}
