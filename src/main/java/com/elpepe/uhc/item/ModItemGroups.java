...
public class ModItemGroups {
    public static final ItemGroup UHC_FOOD_GROUP = Registry.register(Registries.ITEM_GROUP, new Identifier(Uhc.MOD_ID, "uhc_food"),
            ItemGroup.create(ItemGroup.Row.TOP, 0).displayName(Text.translatable("itemgroup.uhc_food")).icon(() -> new ItemStack(ModItems.SWEET_BERRIES_JAM)).entries((displayContext, entries) -> {
    ...
    public static final ItemGroup UHC_ITEMS_GROUP = Registry.register(Registries.ITEM_GROUP, new Identifier(Uhc.MOD_ID, "uhc_items"),
            ItemGroup.create(ItemGroup.Row.TOP, 1).displayName(Text.translatable("itemgroup.uhc_items")).icon(() -> new ItemStack(ModItems.RUBY_TOTEM)).entries((displayContext, entries) -> {
    ...
    public static final ItemGroup UHC_BLOCKS = Registry.register(Registries.ITEM_GROUP, new Identifier(Uhc.MOD_ID, "uhc_blocks"),
            ItemGroup.create(ItemGroup.Row.TOP, 2).displayName(Text.translatable("itemgroup.uhc_blocks")).icon(() -> new ItemStack(ModItems.CAST_IRON_CAULDRON_BLOCK_ITEM)).entries((displayContext, entries) -> {
